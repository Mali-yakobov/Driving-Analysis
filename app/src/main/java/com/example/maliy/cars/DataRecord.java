...
public class DataRecord extends AppCompatActivity implements SensorEventListener,OnClickListener{

    private SensorManager sensorManager;
    private Button btnStart, btnStop, btnUpload;
    private boolean started = false;
    private ArrayList<AcceleratorData> sensorData;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        sensorData = new ArrayList<AcceleratorData>();
    ...
    public void onSensorChanged(SensorEvent event) {
        if (started) {
            ...
            AcceleratorData data = new AcceleratorData(timestamp, x, y, z);
            sensorData.add(data);
            sensorManager.unregisterListener(this);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.btnUpload:
                ...
                Toast toast = Toast.makeText(getApplicationContext(), "The data uploaded", Toast.LENGTH_SHORT);
                toast.show();
                break;
            default:
                break;
    ...
    private void openChart() {
        if (sensorData != null || sensorData.size() > 0) {
            ...
            for (AcceleratorData data : sensorData) {
